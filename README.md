...
[![CI Status](http://img.shields.io/travis/Rajeev Prasad/RComposeBar.svg?style=flat)](https://travis-ci.org/Rajeev Prasad/RComposeBar)
...
RComposeBar is available under the MIT license. See the LICENSE file for more info.
